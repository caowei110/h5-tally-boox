	...
	<view>
		<picker :title="index" @change="bindTimeChange" @columnchange="columnchange" mode="multiSelector" :disabled="disabled" :class="{disabled:disabled}"
		 :value="index" :range="array">
			...
			<text style="margin-right: 20rpx">{{showTime}}</text>
			<uni-icons type="arrowdown" color="green" size="20"></uni-icons>
			<!-- <button type="primary" style="line-height: 50rpx;margin-right: 20rpx;height: 50rpx;" size="mini">点击切换</button> -->
			</view>
